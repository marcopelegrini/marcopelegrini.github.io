...
author: marco
tags: [Hardware, Keyboard, Teams, Microsoft, public]
categories: [ Hardware ]
image: assets/images/marcopad/cta.jpg
...
It's built using the [RP-2040 Zero](https://www.waveshare.com/wiki/RP2040-Zero) as MCU, [Choc](https://keebd.com/en-ca/collections/choc-switches) mechanical keyboard switches, [SK6812](https://www.adafruit.com/product/4960) MINI-E RGB LEDs for backlighting (optional) and simple discrete electronic components.
...
If you're a Microsoft employee you can visit [http://aka.ms/teams-macropad](http://aka.ms/teams-macropad) and watch the demo.
...
![fivehundred]({{ site.baseurl }}/assets/images/marcopad/pcb-mounted.jpg)
...
![fivehundred]({{ site.baseurl }}/assets/images/marcopad/3d-pla-base.jpg)

## Faceplate

I've custom designed a faceplate for laser cutting.

![fivehundred]({{ site.baseurl }}/assets/images/marcopad/faceplate.jpg)
...
![fivehundred]({{ site.baseurl }}/assets/images/marcopad/keys.jpg)
...
For instance, if you want the bottom-left key (currently `KC_P1`) to function as "copy":
Replace `KC_P1` with `LCMD(KC_C)` on macOS or `LCTL(KC_C)` on Windows.
