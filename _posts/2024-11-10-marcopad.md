...
categories: [ Hardware ]
image: assets/images/marcopad/hardware/marcopad-cta.jpg
...
![fivehundred]({{ site.baseurl }}/assets/images/marcopad/hardware/pcb-mounted.jpg)

## Base

I've custom designed a base which can be 3D printed using PLA, Resin or other materials.

![fivehundred]({{ site.baseurl }}/assets/images/marcopad/hardware/3d-pla-base.jpg)

## Faceplate

I've custom designed a faceplate for laser cutting.

![fivehundred]({{ site.baseurl }}/assets/images/marcopad/hardware/faceplate.jpg)
...
![fivehundred]({{ site.baseurl }}/assets/images/marcopad/hardware/keys.jpg)
